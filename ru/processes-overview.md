...
выполняется команда cocaine-tool. Или той, которая указана в команде явно.
...
```
Хотя команда называется app start, по этой команде
...
[ape-details](ape-details.md). Подразумевается, что в
